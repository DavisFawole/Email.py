...
populate_inbox("kaihavertz@outlook.com", "Welcome", "Welcome to your new email inbox.")
populate_inbox("reece.james@company.com", "Package", "A package has arrived for you at reception")
populate_inbox("hr@malogusto.com", "Reference Request", "We are acquiring about a reference for the above individual")
